 ...
 */
int input_register_notifier_client(struct notifier_block *nb)
{
	return blocking_notifier_chain_register(&input_notifier_list, nb);
}
EXPORT_SYMBOL(input_register_notifier_client);

/**
 *	input_unregister_notifier_client - unregister a input client notifier
 *	@nb: notifier block to callback on events
 */
int input_unregister_notifier_client(struct notifier_block *nb)
{
	return blocking_notifier_chain_unregister(&input_notifier_list, nb);
}
EXPORT_SYMBOL(input_unregister_notifier_client);
...
EXPORT_SYMBOL_GPL(input_notifier_call_chain);
