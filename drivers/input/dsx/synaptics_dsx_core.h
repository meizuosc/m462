...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_DSX_GESTURE
#define	M76_TP_GESTURE_SUPPORT 
#endif
...
#define SYN_COVER_MODE (3)
#define SYN_GLOVE_MODE (4)
#define SYN_HOVER_MODE (5)
#define SYN_SUSPEND_SYSTEM   (6)
#define SYN_RESUME_SYSTEM   (7)

#define SYN_HALL_ADDR (0x0426)
#define SYN_GLOVE_ADDR	(0x001D)
#define SYN_HOVER_ADDR 	(0x001E)
#define SYN_HOVER_DOZE	(0x000E)
#define SYN_GLOVE_DETECTION_ADDR	(0x001F)
#define SYN_GLOVE_BIT	(5)   //[5]
#define SYN_HOVER_BIT	(4)	  //[4]
#define SYN_HOVER_DOZE_BIT	(3)	  //[3]
#define SYN_HOVER_FEATURES (0)  //[1] [0] 
#define SYN_GLOVE_DETECTION_BIT	(1)  // [0]
#define SYN_HALL_BIT (1) // [0]

#define SYN_MARGIN_CONTROL_ADDR	(0x043A)
#define SYN_LEFT_MARGIN_ADDR	(0x0446)
#define SYN_RIGHT_MARGIN_ADDR	(0x043B)
#define SYN_TOP_MARGIN_ADDR		(0x043C)
#define SYN_BOTTOM_MARGIN_ADDR	(0x0447)
#define SYN_WATER_CONTROL_ADDR	(0x0445)
...
struct synaptics_rmi4_data {
	...
	int sensor_max_x;
	int sensor_max_y;
//	int margin_control; //margin control information
	char water_control; //water reject function
	...
	bool disable_all ;
	int  gesture_value  ;
	char gesture_mask[4];/*byte0:unicode,byte1:swipe,byte3:tap */
//	bool touch_debug ;
	bool sensor_sleep;
	bool stay_awake;
	bool glove_bit;
