 ...
 */
#define RET_SECDRV_OK                    0
#define RET_SECDRV_ERR_UNKNOWN_CMD       1
#define RET_SECDRV_ERR_NOT_SUPPORTED     2
#define RET_SECDRV_ERR_INTERNAL_ERROR    3
/* ... add more error codes when needed */
#define RET_SECDRV_CUSTOMER_START		10
