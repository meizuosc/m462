...
static int arizona_irq_enable = 1;
...
err_enable:
	regulator_bulk_disable(arizona->num_core_supplies,
			       arizona->core_supplies);
err_get:
    devm_regulator_put(arizona->dcvdd);
err_bulk_get:
    devm_regulator_bulk_put(dev, arizona->num_core_supplies,
				      arizona->core_supplies);
err_early:
