...
enum devfreq_isp_idx {
	...
	LV5,
	LV6,
#if defined(CONFIG_EXYNOS5430_FHD) || defined(CONFIG_EXYNOS5430_WQHD) || defined(CONFIG_MINI_ASV_TABLE)
	LV7,
	LV8,
#endif
	LV_COUNT,
...
#elif defined(CONFIG_EXYNOS5430_FHD) || defined(CONFIG_EXYNOS5430_WQHD) || defined(CONFIG_MINI_ASV_TABLE)
struct devfreq_opp_table devfreq_isp_opp_list[] = {
	{LV0,	777000, 950000},	/* CAM0(L0), ISP&CAM1(L0-A) */
	{LV1,	666000,	950000},	/* CAM0(L0), ISP&CAM1(L0-B) */
	{LV2,	555000,	950000},	/* CAM0(L0), ISP&CAM1(L0-C) */
	{LV3,	466000,	950000},	/* CAM0(L0), ISP&CAM1(L1-A) */
	{LV4,	455000,	950000},	/* CAM0(L0), ISP&CAM1(L1-B) */
	{LV5,	444000,	950000},	/* CAM0(L1), ISP&CAM1(L1-A) */
	{LV6,	333000, 950000},	/* CAM0(L1), ISP&CAM1(L1-B) */
	{LV7,	222000,	950000},	/* CAM0(L2), ISP&CAM1(L1-A) */
	{LV8,	111000,	925000},	/* CAM0(L3), ISP&CAM1(L3)   */
};
#endif
...
struct devfreq_clk_state aclk_csis2_552_isp_pll[] = {
	{MOUT_ACLK_CSIS2_A,	MOUT_ACLK_CAM1_552_USER},
	{MOUT_ACLK_CSIS2_B,	MOUT_ACLK_CSIS2_A},
};

struct devfreq_clk_state aclk_lite_c_552_isp_pll[] = {
...
struct devfreq_clk_states aclk_csis2_552_isp_pll_list = {
	.state = aclk_csis2_552_isp_pll,
	.state_count = ARRAY_SIZE(aclk_csis2_552_isp_pll),
};

struct devfreq_clk_states aclk_lite_c_552_isp_pll_list = {
	.state = aclk_lite_c_552_isp_pll,
	.state_count = ARRAY_SIZE(aclk_lite_c_552_isp_pll),
};
...
struct devfreq_clk_info sclk_pixel_333[] = {
	...
	{LV7,	  80000000,	0,	&sclk_pixelasync_lite_c_list},
	{LV8,	  80000000,	0,	&sclk_pixelasync_lite_c_list},
};
#endif
...
struct devfreq_clk_info aclk_cam1_552[] = {
	...
	{LV7,	552000000,	0,	&aclk_cam1_552_isp_pll_list},
...
struct devfreq_clk_info aclk_fd_400[] = {
	...
	{LV7,	317000000,	0,	&aclk_fd_400_mfc_pll_list},
...
#elif defined(CONFIG_EXYNOS5430_FHD) || defined(CONFIG_EXYNOS5430_WQHD) || defined(CONFIG_MINI_ASV_TABLE)
struct devfreq_clk_info aclk_csis2_333[] = {
	{LV0,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV1,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV2,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV3,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV4,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV5,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV6,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
	{LV7,	 184000000,	0,	&aclk_csis2_552_isp_pll_list},
...
#elif defined(CONFIG_EXYNOS5430_FHD) || defined(CONFIG_EXYNOS5430_WQHD) || defined(CONFIG_MINI_ASV_TABLE)
struct devfreq_clk_info aclk_lite_c[] = {
	{LV0,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV1,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV2,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV3,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV4,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV5,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV6,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
	{LV7,	 184000000,	0,	&aclk_lite_c_552_isp_pll_list},
...
struct devfreq_clk_info aclk_isp_400[] = {
	...
	{LV7,	267000000,	0,	&aclk_isp_400_bus_pll_list},
...
struct devfreq_clk_info aclk_isp_dis_400[] = {
	...
	{LV7,	267000000,	0,	&aclk_isp_dis_400_bus_pll_list},
