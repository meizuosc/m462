...
typedef enum {
	PPMU1_EVENT_RD_BUSY_CYCLE,
	PPMU1_EVENT_WR_BUSY_CYCLE,
	PPMU1_EVENT_RW_BUSY_CYCLE,
	PPMU1_EVENT_RD_REQ,
	PPMU1_EVENT_WR_REQ,
	PPMU1_EVENT_RD_DATA,
	PPMU1_EVENT_WR_DATA,
	PPMU1_EVENT_RD_LATENCY_REQ = 0x12,
	PPMU1_EVENT_WR_LATENCY_REQ = 0x16,
	PPMU2_EVENT_RD_ACTIVATED = 0x0,
	PPMU2_EVENT_WR_ACTIVATED,
	PPMU2_EVENT_RD_REQ,
	PPMU2_EVENT_WR_REQ,
	PPMU2_EVENT_RD_DATA,
	PPMU2_EVENT_WR_DATA,
	PPMU2_EVENT_WR_RESP,
	PPMU2_EVENT_RD_REQ_BLOCKING = 0x10,
	PPMU2_EVENT_WR_REQ_BLOCKING,
	PPMU2_EVENT_RD_DATA_BLOCKING,
	PPMU2_EVENT_WR_DATA_BLOCKING,
	PPMU2_EVENT_WR_RESP_BLOCKING
} PPMU_EVENT012;

typedef enum {
	PPMU1_EVENT3_RD_BUSY_CYCLE,
	PPMU1_EVENT3_WR_BUSY_CYCLE,
	PPMU1_EVENT3_RW_BUSY_CYCLE,
	PPMU1_EVENT3_RD_REQ,
	PPMU1_EVENT3_WR_REQ,
	PPMU1_EVENT3_RD_DATA,
	PPMU1_EVENT3_WR_DATA,
	PPMU1_EVENT3_RW_DATA,
	PPMU1_EVENT3_RW_REQ = 0xa,
	PPMU1_EVNET3_RD_LATENCY_DATA = 0x10,	/* ARV_RLAST */
	PPMU1_EVNET3_RD_LATENCY_REQ = 0x12,
	PPMU1_EVNET3_WR_LATENCY_DATA = 0x15,	/* AWV_BRESP */
	PPMU1_EVNET3_WR_LATENCY_REQ = 0x16,
	PPMU2_EVENT3_RD_ACTIVATED = 0x0,
	PPMU2_EVENT3_WR_ACTIVATED,
	PPMU2_EVENT3_RD_REQ,
	PPMU2_EVENT3_WR_REQ,
	PPMU2_EVENT3_RD_DATA,
	PPMU2_EVENT3_WR_DATA,
	PPMU2_EVENT3_WR_RESP,
	PPMU2_EVENT3_RD_REQ_BLOCKING = 0x10,
	PPMU2_EVENT3_WR_REQ_BLOCKING,
	PPMU2_EVENT3_RD_DATA_BLOCKING,
	PPMU2_EVENT3_WR_DATA_BLOCKING,
	PPMU2_EVENT3_WR_RESP_BLOCKING,
	PPMU2_EVENT3_RW_ACTIVATED = 0x20,
	PPMU2_EVENT3_RW_REQ,
	PPMU2_EVENT3_RW_DATA,
	PPMU2_EVENT3_RW_REQ_BLOCKING,
	PPMU2_EVENT3_RD_LATENCY_REQ,		/* ARV_RLAST */
	PPMU2_EVENT3_WR_LATENCY_REQ		/* AWV_BRESP */
} PPMU_EVENT3;
