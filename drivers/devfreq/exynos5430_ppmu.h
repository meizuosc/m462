...
#define MASK_SAMPLE_CODE		0xF0

#define FINE_SAMPLE_CODE		0xF0
#define NORMAL_SAMPLE_CODE		0xE0
#define COARSE_SAMPLE_CODE		0xC0

#define FINE_SAMPLING	30			// 0xF0
#define NORMAL_SAMPLING	60			// 0xE0
#define COARSE_SAMPLING	100			// 0xC0
...
int exynos5430_ppmu_check_deferrable(unsigned long target, unsigned long min, unsigned long locked_min);
