...
static inline int s5p_mfc_run_enc_frame(struct s5p_mfc_ctx *ctx)
{
	...
	*/
	...
	//kun.bi, for cts  com.android.cts.videoperf.VideoEncoderDecoderTest#testAvc0176x0144
	//if not comit,the last encoded out frame size is 0
