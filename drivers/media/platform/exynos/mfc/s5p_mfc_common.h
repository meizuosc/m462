...
//#define CONFIG_MFC_TRACE_DEV
//#define CONFIG_MFC_TRACE_CTX

#ifdef CONFIG_MFC_TRACE_DEV
...
#else
#define MFC_TRACE_DEV(fmt, args...) do { } while (0)
#endif

#ifdef CONFIG_MFC_TRACE_CTX
...
#else
#define MFC_TRACE_CTX(fmt, args...) do { } while (0)
#endif
...
struct s5p_mfc_dev {
	...
	*/
	...
	struct pm_qos_request qos_req_cpu_num;
	int isLockCpuNum;
	int curMb;
