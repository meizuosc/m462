...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_PREVIEW_13M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_PREVIEW_5M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAPTURE_20M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAPTURE_13M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAPTURE_5M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_4K);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_2K);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_FHD);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_720P);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_480P);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_HIGH_SPEED_FPS);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_VT1);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_VT2);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_SMART_STAY);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_PREVIEW_5M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_PREVIEW_FHD);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_CAPTURE_5M);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_CAPTURE_FHD);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_CAMCORDING_2K);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_CAMCORDING_FHD);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_HIGH_SPEED_FPS);
#else
...
static struct fimc_is_dvfs_scenario static_scenarios[] = {
	{
		.scenario_id		= FIMC_IS_SN_FRONT_PREVIEW_5M,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_FRONT_PREVIEW_5M),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_PREVIEW_5M),
	}, {
		...
		.scenario_id		= FIMC_IS_SN_FRONT_CAMCORDING_2K,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_FRONT_CAMCORDING_2K),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_CAMCORDING_2K),
	}, {
		...
		.scenario_id		= FIMC_IS_SN_FRONT_HIGH_SPEED_FPS,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_FRONT_HIGH_SPEED_FPS),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_HIGH_SPEED_FPS),
	}, {
		...
		.scenario_id		= FIMC_IS_SN_FRONT_SMART_STAY,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_FRONT_SMART_STAY),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_SMART_STAY),
	},	{
		.scenario_id		= FIMC_IS_SN_REAR_PREVIEW_13M,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_PREVIEW_13M),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_PREVIEW_13M),
	}, {
		.scenario_id		= FIMC_IS_SN_REAR_PREVIEW_5M,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_PREVIEW_5M),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_PREVIEW_5M),
	}, {
		.scenario_id		= FIMC_IS_SN_REAR_CAPTURE_20M,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAPTURE_20M),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAPTURE_20M),
	}, {
		.scenario_id		= FIMC_IS_SN_REAR_CAMCORDING_4K,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAMCORDING_4K),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_4K),
	}, {
		.scenario_id		= FIMC_IS_SN_REAR_CAMCORDING_2K,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAMCORDING_2K),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_2K),
	}, {
		...
		.scenario_id		= FIMC_IS_SN_REAR_CAMCORDING_720P,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAMCORDING_720P),
		.check_func 	= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_720P),
	}, {
		.scenario_id		= FIMC_IS_SN_REAR_CAMCORDING_480P,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAMCORDING_480P),
		.check_func 	= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_480P),
	}, {
		.scenario_id		= FIMC_IS_SN_REAR_HIGH_SPEED_FPS,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_HIGH_SPEED_FPS),
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_HIGH_SPEED_FPS),
	}
};
...
static struct fimc_is_dvfs_scenario dynamic_scenarios[] = {
	{
		.scenario_id		= FIMC_IS_SN_REAR_CAPTURE_13M,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAPTURE_13M),
		.keep_frame_tick	= KEEP_FRAME_TICK_DEFAULT,
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAPTURE_13M),
	},
	{
		.scenario_id		= FIMC_IS_SN_REAR_CAPTURE_5M,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR_CAPTURE_5M),
		.keep_frame_tick	= KEEP_FRAME_TICK_DEFAULT,
		.check_func		= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAPTURE_5M),
	},
};
#else
static struct fimc_is_dvfs_scenario static_scenarios[] = {
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_PREVIEW_5M)
{
	if ((device->sensor->pdev->id == SENSOR_POSITION_FRONT) &&
			!(((device->setfile & FIMC_IS_SETFILE_MASK) \
				...
				((device->setfile & FIMC_IS_SETFILE_MASK) \
					== ISS_SUB_SCENARIO_FRONT_SMART_STAY) ||
				((device->setfile & FIMC_IS_SETFILE_MASK) \
					== ISS_SUB_SCENARIO_VIDEO)) && \
				((fimc_is_sensor_g_bns_width(device->sensor) - device->margin_width) *  \
				(fimc_is_sensor_g_bns_height(device->sensor) - device->margin_height) > SIZE_FHD))
		return 1;
	else
		return 0;
}
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_FRONT_CAMCORDING_2K)
{
	...
	bool setfile_flag = (mask == ISS_SUB_SCENARIO_VIDEO) ||
			(mask == ISS_SUB_SCENARIO_VIDEO_HDR)		||
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_PREVIEW_13M)
{
	if ((device->sensor->pdev->id == SENSOR_POSITION_REAR) &&
			(fimc_is_sensor_g_framerate(device->sensor) <= 30) &&
			(((fimc_is_sensor_g_bns_width(device->sensor) - device->margin_width) >= 4000) && \
			((fimc_is_sensor_g_bns_width(device->sensor) - device->margin_width) < 5000)) && \
			((device->setfile & FIMC_IS_SETFILE_MASK) \
			 != ISS_SUB_SCENARIO_VIDEO))
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_720P)
{
	...
	if ((device->sensor->pdev->id == SENSOR_POSITION_REAR) &&
			(fimc_is_sensor_g_framerate(device->sensor) < 60) &&
			(device->chain3_width * device->chain3_height <= SIZE_720P) &&
			(device->chain3_width * device->chain3_height > SIZE_480P) &&
			setfile_flag)
		return 1;
	else
		return 0;
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR_CAMCORDING_480P)
{
	...
	if ((device->sensor->pdev->id == SENSOR_POSITION_REAR) &&
			(fimc_is_sensor_g_framerate(device->sensor) < 60) &&
			((fimc_is_sensor_g_bns_width(device->sensor) - device->margin_width) <= 1296) &&
			((fimc_is_sensor_g_bns_height(device->sensor) - device->margin_height) <= 974) &&
			setfile_flag)
		return 1;
	else
		return 0;
...
int fimc_is_set_dvfs(struct fimc_is_device_ischain *device, u32 scenario_id)
{
	...
	pr_info("%s(), [RSC:%d]: scenario:%d, New QoS:\n "
			"\t[INT(%d), MIF(%d), CAM(%d), DISP(%d), I2C(%d), PWM(%d) CPU(%d/%d)]\n",
			__func__, device->instance, scenario_id, int_qos, mif_qos,
