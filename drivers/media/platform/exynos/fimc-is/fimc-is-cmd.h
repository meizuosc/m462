...
enum is_cmd {
	...
	HIC_MSC_SET_SHOTDONE_PROC_TIME=0x500,
	HIC_MSC_GET_SHOTDONE_PROC_TIME,

	HIC_MSC_SET_CPU_USAGE_RATE,
	HIC_MSC_GET_CPU_USAGE_RATE,

	HIC_MSG_INTRSHOT_COUNT,
...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_HD_60FPS = 3,			/* 3: video HD 60fps */
