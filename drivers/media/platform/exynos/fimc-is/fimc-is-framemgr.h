...
#define framemgr_e_barrier_nested_irqs(this, index, flag) \
       spin_lock_irqsave_nested(&this->slock, flag, SINGLE_DEPTH_NESTING)
#define framemgr_x_barrier_nested_irqr(this, index, flag) \
