...
#define GPU_POWERON_SRC_CLK_OSC	0
#elif SOC_NAME == 5430
#ifdef CONFIG_ESPRESSO_TV_PRIMARY
#define GPU_THROTTLING_90_95    500
...
#define GPU_POWERON_SRC_CLK_OSC	1
#else
...
#else	/* EXYNOS5430 Resolution : FHD & HD */
#define MALI_DVFS_START_FREQ		160
...
#elif SOC_NAME == 5433
#define COLD_MINIMUM_VOL		0
#define GPU_DEFAULT_VOLTAGE		937500
#elif SOC_NAME == 5260
#define COLD_MINIMUM_VOL		0
...
int gpu_clock_resume(struct exynos_context *platform);
