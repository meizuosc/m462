...
#if SLSI_INTEGRATION
	BASE_MEM_FOR_PMEM = (1U << 15),
	BASE_MEM_FOR_TMEM = (1U << 16),
	BASE_MEM_NEED_KMAP = (1U << 17),
#endif
};
...
/* MALI_SEC - 1 to 4 for the new 3 flags */
#define BASE_MEM_FLAGS_NR_OUTPUT_BITS 4
#define BASE_MEM_FLAGS_NR_TOTAL_BITS  ((BASE_MEM_FLAGS_NR_INPUT_BITS) + (BASE_MEM_FLAGS_NR_OUTPUT_BITS))
/* MALI_SEC - 15 to 18 for the new 3 flags */
