	...
	int passive_delay, int polling_delay)
{
	...
	/*
	 * No need to implement the hybrid WQ,
	 *  Because the thermal condition will happen,
	 *     only when the CPU is working
	 *
	 */
#else
...
void thermal_zone_device_unregister(struct thermal_zone_device *tz)
{
	...
	if (!tz)
        ...
        /* avoid delete a mutex lock when someone hold it */
	...
	mutex_unlock(&thermal_list_lock);
        ...
        /* there is no need to set interval as work queue canceled before */
//	thermal_zone_device_set_polling(tz, 0);
