 ...
 */
#define POWER_SUPPLY_TYPE_0        (0 << 0)
#define POWER_SUPPLY_TYPE_1        (1 << 0)
...
struct mipi_dsim_device {
	...
	unsigned int power_supply_flags;
	unsigned int lcd_ver;
...
struct mipi_dsim_lcd_driver {
	...
	int	(*read_id)(struct mipi_dsim_device *dsim, unsigned int id_pin);
	int	(*read_ver)(struct mipi_dsim_device *dsim);
...
extern struct mipi_dsim_lcd_driver m6x_mipi_lcd_driver;
#elif defined(CONFIG_DECON_LCD_M7X)
extern struct mipi_dsim_lcd_driver m7x_mipi_lcd_driver;
#endif
