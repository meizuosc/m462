...
#if defined(CONFIG_DECON_LCD_M6X) || defined(CONFIG_DECON_LCD_M7X)
	DT_OPS.get_display_dsi_regulator = get_display_dsi_regulator;
	DT_OPS.init_display_dsi_regulator = init_display_dsi_regulator;
#endif
...
module_init(s5p_decon_disp_register);
