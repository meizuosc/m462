...
#define DSIM_STATUS_STOP_STATE_DATA_LANE_GET(x)	(((x) >> 0) & 0xf)
...
#define DSIM_CLKCTRL_PLL_BYPASS			(1 << 27)
...
#define DSIM_PKT_GO_EN				(1 << 29)
/* The send command packet(s) on this frame VFP */
#define DSIM_PKT_GO_RDY				(1 << 28)
#define DSIM_PKT_SEND_CNT(_x)			((_x) << 16)
#define DSIM_PKT_SEND_CNT_MASK			(0xfff << 16)
...
#define DSIM_B_DPHYCTRL				(0xa4)
#define DSIM_PHYCTRL_B_DPHYCTL(_x)		((_x) << 0)
#define DSIM_PHYCTRL_B_DPHYCTL_MASK		(0x3ff << 0)
...
#define DSIM_M_DPHYCTRL				(0xac)
#define DSIM_PHYCTRL_M_DPHYCTL_VREG_HS		(1 << 30)
