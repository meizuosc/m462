...
int init_display_decon_clocks(struct device *dev)
{
	...
	exynos_display_set_rate(dev, "disp_pll", 24 * MHZ);
#else
	...
	exynos_display_set_divide(dev, "dout_sclk_dsd", 0);
	...
	exynos_display_set_parent(dev, "mout_sclk_dsd_a", "oscclk");

	exynos_display_set_divide(dev, "dout_sclk_decon_eclk", 0);
	...
	exynos_display_set_parent(dev, "mout_sclk_decon_eclk_user", "oscclk");
	...
	exynos_display_set_parent(dev, "mout_disp_pll", "fin_pll");
	exynos_display_set_divide(dev, "dout_sclk_dsim0", 0);
	...
	exynos_display_set_parent(dev, "mout_sclk_dsim0_user", "oscclk");
#else
	exynos_display_set_divide(dev, "dout_aclk_disp_333", 1);
	exynos_display_set_parent(dev, "mout_aclk_disp_333_a", "mout_mfc_pll_div2");
	exynos_display_set_parent(dev, "mout_aclk_disp_333_b", "mout_aclk_disp_333_a");
...
#ifdef CONFIG_ESPRESSO_TV_PRIMARY
	exynos_display_set_parent(dev, "mout_phyclk_mipidphy_rxclkesc0_user", "oscclk");
	exynos_display_set_parent(dev, "mout_phyclk_mipidphy_bitclkdiv8_user", "oscclk");
#else
...
#endif
#ifndef CONFIG_MACH_ESPRESSO5430
	struct display_driver *dispdrv;
