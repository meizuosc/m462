...
/* Must work with S3C_VA_WATCHDOG */
...
#if CONFIG_S3C2410_WATCHDOG_ATBOOT
...
static int __init start_watchdog_daemon(void)
{
	...
	watchdog_task = kthread_run(watchdog_thread, NULL, "s3c_wdt/daemon");
...
#else
#define start_watchdog_daemon()	do { } while (0)
#endif
