...
enum exynos5433_clks {
	...
	fout_mphy_pll, disp_pll, isp_pll, aud_pll,
	...
	pclk_dsim0 = 640, pclk_mic, pclk_hdmi, pclk_hdmiphy,
	...
	mout_aclk_mfc_400_a = 3280, mout_aclk_mfc_400_b, mout_aclk_mfc_400_c, mout_aclk_mfc_400_user,
...
PNAME(mout_aclk_g3d_p)		= { "mout_g3d_pll", "aclk_g3d" };
/* MFC */
...
struct samsung_mux_clock exynos5433_mux_clks[] __initdata = {
	...
	CMUX(mout_aclk_g3d, EXYNOS5430_SRC_SEL_G3D, 4, 1),
};
...
struct samsung_div_clock exynos5433_div_clks[] __initdata = {
	...
	CDV_A(dout_aclk_bus0_400, "dout_aclk_bus0_400", "mout_bus_pll_user", EXYNOS5430_DIV_TOP4, 4, 3, "dout_aclk_bus0_400"),
	...
	CDIV(dout_pclk_g3d, "mout_aclk_g3d", EXYNOS5430_DIV_G3D, 4, 3),
...
struct samsung_gate_clock exynos5433_gate_clks[] __initdata = {
	...
	CGTE(gate_bts_mfc1_1, "gate_bts_mfc1_1", NULL, EXYNOS5430_ENABLE_IP_MFC11, 5, 0, 0),
	CGTE(gate_bts_mfc1_0, "gate_bts_mfc1_0", NULL, EXYNOS5430_ENABLE_IP_MFC11, 4, 0, 0),
	...
	/* TOP */
	CGTE(aclk_imem_sssx_266, "aclk_imem_sssx_266", "dout_aclk_imem_sssx_266", EXYNOS5430_ENABLE_ACLK_TOP, 29, 0, 0),
	...
	/* Gate for G3D block */
	CGTE(sclk_hpm_g3d, "sclk_hpm_g3d", "dout_sclk_hpm_g3d", EXYNOS5430_ENABLE_SCLK_G3D, 0, 0, 0),
	CGTE(aclk_g3dnd_600, "aclk_g3dnd_600", "mout_aclk_g3d", EXYNOS5430_ENABLE_ACLK_G3D, 1, 0, 0),
	...
	CGTE(aclk_async_g3d, "aclk_async_g3d", "mout_aclk_g3d", EXYNOS5430_ENABLE_ACLK_G3D, 4, 0, 0),
	CGTE(aclk_asyncapbs_g3d, "aclk_asyncapbs_g3d", "dout_pclk_g3d", EXYNOS5430_ENABLE_ACLK_G3D, 5, 0, 0),
	CGTE(aclk_bts_g3d0, "aclk_bts_g3d0", "mout_aclk_g3d", EXYNOS5430_ENABLE_ACLK_G3D, 6, 0, 0),
	CGTE(aclk_bts_g3d1, "aclk_bts_g3d1", "mout_aclk_g3d", EXYNOS5430_ENABLE_ACLK_G3D, 7, 0, 0),
	...
	CGTE(pclk_bts_g3d0, "pclk_bts_g3d0", "dout_pclk_g3d", EXYNOS5430_ENABLE_PCLK_G3D, 2, 0, 0),
	CGTE(pclk_bts_g3d1, "pclk_bts_g3d1", "dout_pclk_g3d", EXYNOS5430_ENABLE_PCLK_G3D, 3, 0, 0),
};
