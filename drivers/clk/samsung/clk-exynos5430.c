...
enum exynos5430_clks {
	...
	mout_aud_mainclk = 4157,
	gate_aud_mainclk = 4158,
...
PNAME(mout_aud_mainclk_p) = { "dummyclk0","dummyclk1","dummyclk2","dummyclk3","dummyclk4",
	"dummyclk5","dummyclk6","dummyclk7","dummyclk8","dummyclk9","dummyclk10",
	"dummyclk11","dummyclk12","dummyclk13","dummyclk14","dummyclk15", "oscclk", };
...
struct samsung_mux_clock exynos5430_mux_clks[] __initdata = {
	...
	/*audio codec main clk */
	CMX(mout_aud_mainclk, "mout_aud_mainclk", mout_aud_mainclk_p, EXYNOS_PMU_DEBUG, 8, 5),
};
...
struct samsung_gate_clock exynos5430_gate_clks[] __initdata = {
...
#else
	CGTE(gate_smmu_tv0x, "gate_smmu_tv0x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 25, CLK_IGNORE_UNUSED, 0),
#endif
	...
	/*audio codec main clk */
	CGTE(gate_aud_mainclk, "gate_aud_mainclk", "mout_aud_mainclk", EXYNOS_PMU_DEBUG, 0, CLK_SET_PARENT_GATE, 0),
};
