...
#define EXYNOS_DEF_MMC_1_CAPS	(MMC_CAP_4_BIT_DATA | MMC_CAP_SDIO_IRQ | \
	MMC_CAP_MMC_HIGHSPEED |MMC_CAP_SD_HIGHSPEED | MMC_CAP_CMD23)
#define EXYNOS_DEF_MMC_2_CAPS	(MMC_CAP_CMD23 | MMC_CAP_ERASE)
