...
static struct apll_freq exynos5433_apll_freq_CA7[] = {
	 ...
	 * PLL M, P, S
	 */
	APLL_FREQ(2000, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 500, 6, 0),  /* ARM L0: 2.0GHz   */
	APLL_FREQ(1900, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 475, 6, 0),  /* ARM L1: 1.9GMHz  */
	APLL_FREQ(1800, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 375, 5, 0),  /* ARM L2: 1.8GMHz  */
	APLL_FREQ(1700, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 425, 6, 0),  /* ARM L3: 1.7GHz   */
	APLL_FREQ(1600, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 400, 6, 0),  /* ARM L4: 1.6GHz   */
	APLL_FREQ(1500, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 250, 4, 0),  /* ARM L5: 1.5GMHz  */
	APLL_FREQ(1400, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 350, 6, 0),  /* ARM L6: 1.4GMHz  */
	APLL_FREQ(1300, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 325, 6, 0),  /* ARM L7: 1.3GHz   */
	APLL_FREQ(1200, 0, 0, 2, 7, 7, 7, 3, 0, 2, 7, 0, 500, 5, 1),  /* ARM L8: 1.2GHz   */
	APLL_FREQ(1100, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 550, 6, 1),  /* ARM L9: 1.1GHz   */
	APLL_FREQ(1000, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 500, 6, 1),  /* ARM L10: 1000MHz */
	APLL_FREQ( 900, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 375, 5, 1),  /* ARM L11: 900MHz  */
	APLL_FREQ( 800, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 400, 6, 1),  /* ARM L12: 800MHz  */
	APLL_FREQ( 700, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 350, 6, 1),  /* ARM L13: 700MHz  */
	APLL_FREQ( 600, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 500, 5, 2),  /* ARM L14: 600MHz  */
	APLL_FREQ( 500, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 500, 6, 2),  /* ARM L15: 500MHz  */
	APLL_FREQ( 400, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 400, 6, 2),  /* ARM L16: 400MHz  */
	APLL_FREQ( 300, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 500, 5, 3),  /* ARM L17: 300MHz  */
	APLL_FREQ( 200, 0, 0, 1, 7, 7, 7, 3, 0, 2, 7, 0, 400, 6, 3),  /* ARM L18: 200MHz  */
};
