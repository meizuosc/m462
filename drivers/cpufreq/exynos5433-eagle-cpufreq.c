...
static struct apll_freq exynos5433_apll_freq_CA15[] = {
	 ...
	 * values:
	 * freq
	 * clock divider for EGL1, EGL2, ACLK_EGL, PCLK_EGL, ATCLK, PCLK_DBG_EGL, RESERVED, RESERVED
	 * clock divider for SCLK_EGL_PLL, SCLK_HPM_EGL, RESERVED
	 * PLL M, P, S
	 */
	APLL_FREQ(2500, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 625, 6, 0),    /* ARM L0: 2.5GHz  */
	APLL_FREQ(2400, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 500, 5, 0),    /* ARM L1: 2.4GMHz */
	APLL_FREQ(2300, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 575, 6, 0),    /* ARM L2: 2.3GMHz */
	APLL_FREQ(2200, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 550, 6, 0),    /* ARM L3: 2.2GHz  */
	APLL_FREQ(2100, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 350, 4, 0),    /* ARM L4: 2.1GHz  */
	APLL_FREQ(2000, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 500, 6, 0),    /* ARM L5: 2.0GHz  */
	APLL_FREQ(1900, 0, 0, 4, 7, 7, 7, 0, 0, 1, 7, 0, 475, 6, 0),    /* ARM L6: 1.9GHz  */
	APLL_FREQ(1800, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 375, 5, 0),    /* ARM L7: 1.8GHz  */
	APLL_FREQ(1700, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 425, 6, 0),    /* ARM L8: 1.7GHz  */
	APLL_FREQ(1600, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 400, 6, 0),    /* ARM L9: 1.6GHz  */
	APLL_FREQ(1500, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 250, 4, 0),    /* ARM L10: 1.5GHz */
	APLL_FREQ(1400, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 350, 6, 0),    /* ARM L11: 1.4GHz */
	APLL_FREQ(1300, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 325, 6, 0),    /* ARM L12: 1.3GHz */
	APLL_FREQ(1200, 0, 0, 3, 7, 7, 7, 0, 0, 1, 7, 0, 500, 5, 1),    /* ARM L13: 1.2GHz */
	APLL_FREQ(1100, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 550, 6, 1),    /* ARM L14: 1.1GHz */
	APLL_FREQ(1000, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 500, 6, 1),    /* ARM L15: 1.0GHz */
	APLL_FREQ( 900, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 375, 5, 1),    /* ARM L16: 900MHz */
	APLL_FREQ( 800, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 400, 6, 1),    /* ARM L17: 800MHz */
	APLL_FREQ( 700, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 350, 6, 1),    /* ARM L18: 700MHz */
	APLL_FREQ( 600, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 500, 5, 2),    /* ARM L19: 600MHz */
	APLL_FREQ( 500, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 500, 6, 2),    /* ARM L20: 500MHz */
	APLL_FREQ( 400, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 400, 6, 2),    /* ARM L21: 400MHz */
	APLL_FREQ( 300, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 500, 5, 3),    /* ARM L22: 300MHz */
	APLL_FREQ( 200, 0, 0, 2, 7, 7, 7, 0, 0, 1, 7, 0, 400, 6, 3),    /* ARM L23: 200MHz */
};
...
#ifdef SPEED_OPTION_ENABLED
	if (spd_option_flag == EGL_DISABLE_SPD_OPTION) {
		/* booting frequency is 800MHz */
		info->boot_cpu_min_qos = exynos5433_freq_table_CA15[L17].frequency;
		info->boot_cpu_max_qos = exynos5433_freq_table_CA15[L17].frequency;
	} else {
		/* booting frequency is 1.2GHz */
		info->boot_cpu_min_qos = exynos5433_freq_table_CA15[L13].frequency;
		info->boot_cpu_max_qos = exynos5433_freq_table_CA15[L13].frequency;
	}
#else
		/* booting frequency is 800MHz */
		info->boot_cpu_min_qos = exynos5433_freq_table_CA15[L17].frequency;
