...
static struct map_desc exynos5430_iodesc0[] __initdata = {
	...
	{
		.virtual	= (unsigned long)EXYNOS5430_VA_GPIO_ALIVE,
		.pfn		= __phys_to_pfn(EXYNOS5430_PA_GPIO_ALIVE),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	},
	{
		.virtual	= (unsigned long)EXYNOS5430_VA_RTC,
		.pfn		= __phys_to_pfn(EXYNOS5430_PA_RTC),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	},
	{
