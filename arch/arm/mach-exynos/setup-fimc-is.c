...
int exynos5430_cfg_clk_cam0(struct platform_device *pdev)
{
	...
	/* FIMC LITE C PIXELASYNC*/
	fimc_is_enable_dt(pdev, "gate_pixelasync_lite_c");
	fimc_is_enable_dt(pdev, "gate_pixelasync_lite_c_init");
	fimc_is_disable_dt(pdev, "gate_pixelasync_lite_c");
	fimc_is_disable_dt(pdev, "gate_pixelasync_lite_c_init");
...
int exynos5430_cfg_clk_cam1(struct platform_device *pdev)
{
	...
	/* CAM1 SPI0,1 GATE*/
	fimc_is_enable_dt(pdev, "gate_isp_spi1");
	fimc_is_disable_dt(pdev, "gate_isp_spi1");
