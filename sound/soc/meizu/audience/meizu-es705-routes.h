...
4    BT/WHS (NB/WB)                           	1315	590/591
5    Stereo recording with UI/music PB       	2621	653
...
11   CVQ w/DHWPT
12   CT Voip (2-Mic W UI)                     	1051	752
13   FT Voip (3-Mic W UI, AEC ref)           	1101	558
14   3 Segment headset Voip                  	1005	594
15   BT/WHS VOIP                             	1006	595
...
enum {
	...
	ROUTE_VOICE_CALL_CT,        /* 4 */
	ROUTE_VOICE_CALL_FT,        /* 5 */
	ROUTE_VOICE_CALL_HEADPHONE, /* 6 */
	ROUTE_VOICE_CALL_HEADSET,   /* 7 */

	ROUTE_VOIP_CT,            /* 8 */
	ROUTE_VOIP_FT,            /* 9 */
	ROUTE_VOIP_HEADPHONE,     /* 10 */
	ROUTE_VOIP_HEADSET,       /* 11 */

	ROUTE_VOICE_MESSAGE_RECORD,  /* 12 */

	ROUTE_FACTORY_TEST_TOP_MIC,    /* 13 */
	ROUTE_FACTORY_TEST_FRONT_MIC,  /* 14 */
	ROUTE_FACTORY_TEST_BOTTOM_MIC, /* 15 */
	ROUTE_FACTORY_TEST_MODEM_LOOPBACK_EARPHONE, /* 16 */

	ROUTE_VOICE_ASR, /* 17 */

	ROUTE_FACTORY_TEST_MODEM_LOOPBACK_HEADPHONE, /* 18 */

	ROUTE_VOICE_SENSE_PDM = 22,    /* 22 */

	ROUTE_BOARD_MIC_RECORD_44_1KHZ, /* 23 */
	ROUTE_HEADSET_MIC_RECORD_44_1KHZ, /* 24 */

	ROUTE_VOICE_CALL_WB_CT,        /* 25 */
	ROUTE_VOICE_CALL_WB_FT,        /* 26 */
	ROUTE_VOICE_CALL_WB_HEADPHONE, /* 27 */
	ROUTE_VOICE_CALL_WB_HEADSET,   /* 28 */
...
static const u32 route_off[] = {
	...
	0x903101f8, /* #504  : Port B-PCM-slave */
...
static const u32 route_stereo_record_with_48khz_uitone[] = {
	...
	0x8031028c, /* #652 : Avalon Algo Preset Record 24K - Without NS */
	0xffffffff, /* terminate */
};
...
static const u32 route_stereo_record_with_44_1khz_uitone[] = {
	0x90520000, /* #DHWPT : disable */
	0x90310202, /* #514  : Port A master-44.1k */
	//0x90310205, /* #517  : Port D master-44.1k */
	0x90310a3d, /* #2621 : Stereo recording with UI/music PB */
	//0x8031028d, /* #653 : Avalon Algo Preset Record 24K */
	0x8031028c, /* #652 : Avalon Algo Preset Record 24K - Without NS */
	0xffffffff, /* terminate */
};
static const u32 route_headset_mic_record_with_44_1khz_uitone[] = {
	0x90520000, /* #DHWPT : disable */
	0x90310202, /* #514  : Port A master-44.1k */
	//0x90310205, /* #517  : Port D master-44.1k */
	0x90310487, /* #1159 : Mono recording with UI/music PB */
...
static const u32 route_voip_2mic_ct[] = {
	...
	0x803102f0, /* #752 : CT Voip (2-Mic W UI) */
	0xffffffff, /* terminate */
};
static const u32 route_voip_2mic_ft[] = {
	...
	0x8031022e, /* #558 : FT Voip (3-Mic W UI, AEC ref) */
	0xffffffff, /* terminate */
};
static const u32 route_voip_headphone[] = {
	...
	0x80310252, /* #594 : 3 Segment headset Voip */
	0xffffffff, /* terminate */
};
...
static const struct esxxx_route_config es705_route_config[ROUTE_MAX] = {
	...
	[ROUTE_BOARD_MIC_RECORD_44_1KHZ] = {
		.route = route_stereo_record_with_44_1khz_uitone,
	},
	[ROUTE_HEADSET_MIC_RECORD_44_1KHZ] = {
		.route = route_headset_mic_record_with_44_1khz_uitone,
	},
