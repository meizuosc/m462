...
/** don't check rate|wl|fmt in hw_param() and set_fmt(), that will
 *  cause system silent when resume from voice sense mode.
 *  Known issue: a little latency while playing ui tone.
 */
