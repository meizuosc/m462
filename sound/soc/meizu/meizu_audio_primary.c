	...
	struct snd_pcm_hw_params *params)
{
	...
	/* cpu dai format configuration: i2s0 -> slave */
	...
	struct snd_pcm_hw_params *params)
{
	 ...
	 *   wm8998-aif1 -> master, i2s0 -> slave; es705 works at DHWPT mode */
	...
	struct snd_pcm_hw_params *params)
{
	...
	// some where need to know this calling event
...
static const struct snd_soc_dapm_route meizu_wm8998_routes[] = {
	...
	// which brings "MICBIAS2" to be power up.
	{"IN2A", NULL, "Sec Mic"},
	{"IN1AL", NULL, "Ter Mic"},
};
