...
extern signed long __schedule_timeout(signed long timeout, unsigned int flags);
...
extern int set_hmp_semiboostpulse(int duration);
...
#else
#define sched_update_nr_prod(cpu, nr, inc)	do { } while (0)
#endif
