...
#define ABS_FLUSH_ISL	ABS_MISC+3
...
#define WHITE_HIGH_LUX_COEF	8545
#define BLACK_HIGH_LUX_COEF	9696
#define WHITE_LOW_LUX_COEF	320
#define BLACK_LOW_LUX_COEF	364
...
struct isl29125_data_t {
	...
	// read data
	unsigned short cache_red;
	unsigned short cache_green;
	unsigned short cache_blue;
