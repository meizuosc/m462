...
extern int register_temp_notifier(struct notifier_block *n);

extern int unregister_temp_notifier(struct notifier_block *n);
#define FREEZE_TEMP	0x0001	/* Notify of battery temperature */
#define COLD_TEMP	0x0002
#define ROOM_TEMP       0x0003
#define HOT_TEMP     0x0004
#define FULL_CAP       0x0005
