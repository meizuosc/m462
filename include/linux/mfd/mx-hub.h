...
#define MX_HUB_REG_LED_BASE									0x49
#define MX_HUB_REG_LED_BRN						(MX_HUB_REG_LED_BASE + 0)					
#define MX_HUB_REG_LED_SLP						(MX_HUB_REG_LED_BASE + 1)					
#define MX_HUB_REG_LED_FADE						(MX_HUB_REG_LED_BASE + 2)					
#define MX_HUB_REG_LED_SLPPRD						(MX_HUB_REG_LED_BASE + 3)					
#define MX_HUB_REG_LED_SLPPRDH						(MX_HUB_REG_LED_BASE + 4)					
#define MX_HUB_REG_LED_TEST						(MX_HUB_REG_LED_BASE + 5)					
...
*/
    struct CWMCU_platform_data *board_data;
    bool is_update;
    struct mutex iolock;
    ...
    int report_period[CW_SENSORS_ID_END];/* ms */
	uint8_t acc_cal[32];
	uint8_t gyro_cal[32];
    int report_time;
    u32 update_list;
    ...
    struct wake_lock sensorhub_wakelock; 
};
...
extern int mx_hub_read_addr(struct CWMCU_data *sensor, u8 addr, int bytes, void *dest);
extern int mx_hub_write_addr(struct CWMCU_data *sensor, u8 reg, int bytes, const void *src);
