...
#ifdef CONFIG_POWER_MODE
	unsigned int freq_clip_max_kfc_powerm[POWER_MODE_END];
#endif
#endif
	unsigned int temp_level;
#ifdef CONFIG_POWER_MODE
	unsigned int temp_level_powerm[POWER_MODE_END];
#endif
...
struct exynos_tmu_platform_data {
	...
	u8 trigger_levels[POWER_MODE_CUSTOM][8];
...
#ifdef CONFIG_POWER_MODE
	unsigned int freq_tab_count_powerm[POWER_MODE_CUSTOM];
#endif
